...
namespace TadoNetApi.Infrastructure.Dtos.Responses
{
    ...
    public class TadoDeviceResponse
    {
        ...
        public TadoConnectionStateResponse? ConnectionState { get; set; }

        /// <summary>
        /// The characteristics of the device
        /// </summary>
        [JsonPropertyName("characteristics")]
        public TadoCharacteristicsResponse? Characteristics { get; set; }
        ...
        public TadoMountingStateResponse? MountingState { get; set; }
