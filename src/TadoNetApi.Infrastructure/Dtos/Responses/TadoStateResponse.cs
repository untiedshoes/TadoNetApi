...
namespace TadoNetApi.Infrastructure.Dtos.Responses
{
    ...
    /// </summary>
    public class TadoStateResponse
    {
        /// <summary>
        ...
        public TadoOverlayResponse? Overlay { get; set; }
